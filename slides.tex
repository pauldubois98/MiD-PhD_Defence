...
\begin{document}
	...
	\begin{frame}
		...
		Lectures:
		\begin{itemize}
			\item Mathematics Refresher Course for DSBA 2021			\item Deep Learning for HSB 2023
		\end{itemize}
		TDs:
		\begin{itemize}
			\item Coding Weeks (1st year) 2021
			\item Optimization (1st year) 2021
			\item Visual recognition (3rd year) 2022
			\item Coding Weeks (1st year) 2022
			\item Algorithm and Complexity (2nd year) 2022/2023
		\end{itemize}
	\end{frame}
