...
\begin{document}
	...
	\begin{frame}
		...
		\begin{figure}
			\includegraphics[height=6cm]{vector_images/fluence_bixelization.pdf}
	...
	\begin{frame}
		...
		\begin{figure}
			\includegraphics[height=6cm]{vector_images/sliding_window_curve.pdf}
	...
	\begin{figure}
		\includegraphics[height=6cm]{matrix_images/demo_QR_code.png}
	\end{figure}
